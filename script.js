...
/*Your task is to apply different arrays methods to get the desired following result.
...
function getAllVegetablesData() {
    const newArray = FoodOriginalData.filter(
...
//10th
let sortedProtienData = FoodOriginalData.sort(function (a, b) {
    return b.protiens - a.protiens
});
// 11th 
let sortedCobData = FoodOriginalData.sort(function (a, b) {
    return a.cab - b.cab
});
